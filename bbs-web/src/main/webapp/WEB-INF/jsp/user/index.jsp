	...
	<script src="${APP_PATH}/layer/layer.js"></script>
        <script type="text/javascript">
            			...
            			if ( result.success ) {
            				...
            				$.each(users, function(i, user){
            	                tableContent += '<tr>';
	          	                ...
	          	                tableContent += '  <td>';
	          					tableContent += '      <button type="button" onclick="goAssignPage('+user.userId+')" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-check"></i></button>';
            ...
            function goUpdatePage(id) {
            	window.location.href = "${APP_PATH}/user/edit?userId="+id;
            }
            
            function goAssignPage(id) {
            	window.location.href = "${APP_PATH}/user/assign?userId="+id;
            }
